...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Audio audio1 = new Audio(RecognitionMode.INTERACTIVE, language1);
        audio1.setAudioFile(file1);
        ...
        Audio audio2 = new Audio(RecognitionMode.CONVERSATION, language2, OutputFormat.DETAILED, file2);
